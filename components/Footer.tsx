...
const Footer = () => {
  return (
    <footer className="text-gray-400 bg-darkMode body-font">
      ...
      <div className="bg-lightDarkMode">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
            ...
            <span className="ml-3 text-xl">TinoMaster</span>
          </a>
          <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">
            © 2023 TinoMaster —
            <Link
              href="https://tinomaster.website"
              className="text-gray-400 border-b border-slate-400 ml-1"
              target="_blank"
