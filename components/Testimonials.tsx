  ...
  return (
    <section className="container text-gray-600 body-font">
      <div className="container px-5 py-20 mx-auto">
        <h3 className="text-center pb-5 text-primary">Testimonials</h3>
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          ...
          <p className="text-gray-300 opacity-75 text-lg">
            ...
            skateboard four loko knausgaard.
          </p>
          <span className="inline-block h-1 w-10 rounded bg-primary mt-8 mb-6"></span>
          <h2 className="text-primary font-medium title-font tracking-wider text-sm">
            Maria Chequetti
          </h2>
        </div>
      </div>
