   ...
   return (
      <>
         ...
         <Link
            ...
            className="text-xs lg:text-sm bg-gray-100/5 shadow-lg rounded-lg p-6 transition duration-300 hover:scale-105 hover:shadow-2xl hover:cursor-pointer hover:bg-gray-100/10"
         >
