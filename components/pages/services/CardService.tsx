...
export const CardService = ({ Icon, title, href }: CardServiceProps) => {
   ...
   if (isActive) {
      return (
         <div className="relative w-24 h-32 lg:h-56 lg:w-48 m-auto overflow-hidden rounded-xl border border-primary p-[1px] backdrop-blur-3xl">
   ...
   return (
      <Link
         href={href}
         className="relative w-24 h-32 lg:h-56 lg:w-48 bg-black/10 hover:bg-white/5 transition-colors m-auto overflow-hidden rounded-xl  p-[1px]"
      >
