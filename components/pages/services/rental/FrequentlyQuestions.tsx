   ...
   return (
      <div className="leading-relaxed mt-12 mx-4 md:mx-8">
         <div className="text-center space-y-3">
            <h1 className="block text-primary text-3xl font-semibold">
         ...
         <div className="relative rounded-md mt-10 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl sm:mx-auto shadow-lg shadow-black/20">
