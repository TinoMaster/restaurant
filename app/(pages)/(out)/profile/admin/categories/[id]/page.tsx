                  ...
                  <div className="w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                     ...
                     <div className="grid my-10">
                        {products && products.length > 0 ? (
                           ...
                           <p>
                              Aun no hay productos agregados a esta categoria
                           </p>
                        )}
                     </div>

                     <div className="flex">
                        <button className="flex ml-auto text-white bg-red-500/80 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                           Delete
                        </button>
                     </div>
                  </div>
