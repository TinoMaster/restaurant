export default function LoadingSkeletonPages() {
   return (
      <div className="flex flex-col items-center w-screen h-screen bg-darkMode/5 animate-pulse">
         {/* Skeleton del banner que ocupa el 60% de la altura visible (vh) */}
         <div className="bg-darkMode/20 h-[60vh] w-full mb-4 flex flex-col gap-2 justify-center items-center animate-pulse">
